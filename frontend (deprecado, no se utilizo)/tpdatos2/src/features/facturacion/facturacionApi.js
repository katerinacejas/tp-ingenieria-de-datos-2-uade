import { USE_MOCK } from '../../app/config.js'   // ← acá estaba el error
...
export async function getFacturas() {
  ...
  // cuando conectes backend, ajustá el path si fuese distinto
  return await fetchApi('/facturas', { method: 'GET' })
}
